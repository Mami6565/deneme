...
if(!args[0]) return message.channel.send(`Bir argüman girmelisin: m!çekiliş başlat/tekrar`)
let arg = ['başlat', 'tekrar']
if(!arg.includes(args[0])) return message.channel.send(`Sadece m!çekiliş başlat/tekrar kullanabilirsin.`)
if(args[0] === 'başlat') {
try {
